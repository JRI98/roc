...
(can-ir
	(d-let
		...
		(e-lambda
			(args
				(p-assign (ident "x")))
			(e-dispatch-call (method "to_i128") (constraint-fn-var 332)
				(receiver
					(e-lookup-local
						(p-assign (ident "x"))))
				(args)))
								...
								(patterns
									(pattern (degenerate false)
										(p-list
											...
											(rest-at (index 1)))))
								(value
									(e-dispatch-call (method "to_i128") (constraint-fn-var 360)
										(receiver
											(e-lookup-local
												(p-assign (ident "x"))))
										(args))))
	...
	(d-let
		...
		(e-lambda
			...
			(e-block
				...
				(s-let
					(p-assign (ident "v"))
					(e-type-dispatch-call (method "parse") (type-dispatch-stmt 88) (constraint-fn-var 435)
						(args
							(e-lookup-local
								(p-assign (ident "s"))))))
				(e-dispatch-call (method "show") (constraint-fn-var 437)
					(receiver
						(e-lookup-local
							(p-assign (ident "v"))))
					(args))))
