...
(can-ir
	(d-let
		...
		(e-dispatch-call (method "minus") (constraint-fn-var 236)
			(receiver
				(e-num (value "1")))
			(args
	...
	(d-let
		...
		(e-dispatch-call (method "minus") (constraint-fn-var 286)
			(receiver
				(e-num (value "1")))
			(args
	...
	(d-let
		...
		(e-dispatch-call (method "negate") (constraint-fn-var 290)
			(receiver
				(e-dispatch-call (method "negate") (constraint-fn-var 288)
					(receiver
						(e-lookup-local
							(p-assign (ident "sub_nested"))))
					(args)))
