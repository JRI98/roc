# META
~~~ini
description=List.drop_at_unordered removes an element by swapping it with the last one
type=repl
~~~
# SOURCE
~~~roc
» [1.I64, 2, 3, 4, 5].drop_at_unordered(1)
» [1.I64, 2, 3].drop_at_unordered(2)
» [1.I64, 2, 3].drop_at_unordered(9)
