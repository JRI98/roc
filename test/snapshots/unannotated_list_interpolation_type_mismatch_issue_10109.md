		...
		(e-lambda
			...
			(e-block
				(s-let
					...
					(e-dispatch-call (method "map") (constraint-fn-var 249)
						(receiver
							(e-lookup-local
								(p-assign (ident "list"))))
						(args
							(e-lambda
								...
								(e-block
									(s-let
										...
										(e-lookup-local
											(p-assign (ident "x"))))
									(e-interpolation (constraint-fn-var 247) (dispatcher-var 13)
										(first
											(e-literal (string "")))
										(parts
											(e-lookup-local
				...
				(e-block
					(s-let
						...
						(e-lookup-local
							(p-assign (ident "inner"))))
					(e-interpolation (constraint-fn-var 267) (dispatcher-var 23)
						(first
							(e-literal (string "<tr>")))
						(parts
							(e-lookup-local
