...
(can-ir
										...
										(field (name "items")
											(e-list
												(elems
													(e-lookup-local
														(p-assign (ident "num")))
													(e-dispatch-call (method "times") (constraint-fn-var 1491)
														(receiver
															(e-lookup-local
																(p-assign (ident "num"))))
														(args
															(e-num (value "2"))))
													(e-dispatch-call (method "times") (constraint-fn-var 1526)
														(receiver
															(e-lookup-local
																(p-assign (ident "num"))))
														(args
	...
	(d-let
		...
		(e-dispatch-call (method "plus") (constraint-fn-var 1823)
			(receiver
				(e-lookup-local
					(p-assign (ident "num"))))
			(args
	...
	(d-let
		...
		(e-dispatch-call (method "times") (constraint-fn-var 1858)
			(receiver
				(e-lookup-local
					(p-assign (ident "num"))))
			(args
				...
				(field (name "derived")
					(e-list
						(elems
							(e-lookup-local
								(p-assign (ident "num")))
							(e-dispatch-call (method "plus") (constraint-fn-var 1895)
								(receiver
									(e-lookup-local
										(p-assign (ident "num"))))
								(args
									(e-num (value "1"))))
							(e-dispatch-call (method "plus") (constraint-fn-var 1930)
								(receiver
									(e-lookup-local
										(p-assign (ident "num"))))
								(args
			...
			(fields
				...
				(field (name "computations")
					(e-record
						(fields
							(field (name "from_num")
								(e-dispatch-call (method "times") (constraint-fn-var 1978)
									(receiver
										(e-lookup-local
											(p-assign (ident "num"))))
									(args
							...
							(field (name "from_frac")
								(e-dispatch-call (method "times") (constraint-fn-var 2013)
									(receiver
										(e-lookup-local
											(p-assign (ident "frac"))))
									(args
										(e-dec-small (numerator "10") (denominator-power-of-ten "0") (value "10")))))
	...
	(d-let
		...
		(e-lambda
			(args
				(p-underscore))
			(e-block
				(e-dispatch-call (method "plus") (constraint-fn-var 2056)
					(receiver
