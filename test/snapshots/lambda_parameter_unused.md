...
(can-ir
	...
	(d-let
		...
		(e-lambda
			...
			(e-dispatch-call (method "times") (constraint-fn-var 523)
				(receiver
					(e-lookup-local
						(p-assign (ident "_factor"))))
				(args
	...
	(d-let
		...
		(e-lambda
			...
			(e-dispatch-call (method "times") (constraint-fn-var 763)
				(receiver
					(e-lookup-local
						(p-assign (ident "value"))))
				(args
				...
				(e-dispatch-call (method "plus") (constraint-fn-var 1279)
					(receiver
						(e-dispatch-call (method "plus") (constraint-fn-var 1269)
							(receiver
								(e-dispatch-call (method "plus") (constraint-fn-var 1259)
									(receiver
										(e-lookup-local
											(p-assign (ident "result1"))))
									(args
