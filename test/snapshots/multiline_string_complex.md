	...
	(d-let
		...
		(e-block
			(s-let
				...
				(e-lookup-local
					(p-assign (ident "value1"))))
			(e-interpolation (constraint-fn-var 275) (dispatcher-var 15)
				(first
	...
	(d-let
		...
		(e-block
			(s-let
				...
				(e-lookup-local
					(p-assign (ident "value2"))))
			(e-interpolation (constraint-fn-var 293) (dispatcher-var 25)
				(first
					(e-literal (string "This is a string
With multiple lines
")))
					...
					(e-list
						(elems
							(e-string
								(e-literal (string "multiline"))))))
				(field (name "d")
					(e-dispatch-call (method "minus") (constraint-fn-var 341)
						(receiver
							(e-num (value "0")))
						(args
							(e-string))))
				(field (name "e")
					(e-dispatch-call (method "not") (constraint-fn-var 350)
						(receiver
							(e-string))
						(args))))))
	(d-let
