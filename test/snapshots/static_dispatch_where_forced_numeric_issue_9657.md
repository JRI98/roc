						...
						(e-lambda
							...
							(e-block
								...
								(s-let
									...
									(e-type-dispatch-call (method "decode") (type-dispatch-stmt 28) (constraint-fn-var 124)
										(args
											(e-lookup-local
												(p-assign (ident "input"))))))
								(s-let
	...
	(d-let
		...
		(e-block
			(s-let
				...
				(e-call (constraint-fn-var 176)
					(e-lookup-local
						(p-assign (ident "make_map")))
					(e-lambda
						(args
							(p-assign (ident "n")))
						(e-dispatch-call (method "plus") (constraint-fn-var 174)
							(receiver
								(e-lookup-local
									(p-assign (ident "n"))))
							(args
