	...
	(d-let
		...
		(e-block
			...
			(s-let
				...
				(e-dispatch-call (method "get_or") (constraint-fn-var 637)
					(receiver
						(e-dispatch-call (method "flat_map") (constraint-fn-var 594)
							(receiver
							...
							(args
								(e-lambda
									...
									(e-nominal (nominal "Container")
										(e-tag (name "Value")
											(args
												(e-dispatch-call (method "plus") (constraint-fn-var 586)
													(receiver
														(e-lookup-local
															(p-assign (ident "x"))))
													(args
