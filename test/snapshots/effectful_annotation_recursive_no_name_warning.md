			...
			(e-if
				...
				(if-else
					(e-call (constraint-fn-var 905)
						...
						(e-dispatch-call (method "minus") (constraint-fn-var 825)
							(receiver
								(e-lookup-local
									(p-assign (ident "n"))))
							(args
			...
			(e-if
				(if-branches
					(if-branch
						...
						(e-num (value "2"))))
				(if-else
					(e-call (constraint-fn-var 1260)
						(e-lookup-local
							(p-assign (ident "pingIt")))
						(e-dispatch-call (method "minus") (constraint-fn-var 1180)
							(receiver
								(e-lookup-local
									(p-assign (ident "n"))))
							(args
