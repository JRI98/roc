				...
				(e-block
					(e-if
						(if-branches
							(if-branch
								(e-method-eq (negated "false")
									(lhs
										(e-dispatch-call (method "rem_by") (constraint-fn-var 632)
											(receiver
												(e-lookup-local
													(p-assign (ident "n"))))
											(args
								...
								(e-block
									(s-reassign
										(p-assign (ident "count_"))
										(e-dispatch-call (method "plus") (constraint-fn-var 708)
											(receiver
												(e-lookup-local
													(p-assign (ident "count_"))))
											(args
									...
									(s-reassign
										(p-assign (ident "sum_"))
										(e-dispatch-call (method "plus") (constraint-fn-var 710)
											(receiver
												(e-lookup-local
													(p-assign (ident "sum_"))))
											(args
						...
						(if-else
							(e-block
								(e-empty_record))))))
			(e-dispatch-call (method "times") (constraint-fn-var 720)
				(receiver
					(e-lookup-local
						(p-assign (ident "count_"))))
				(args
