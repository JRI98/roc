										...
										(e-dispatch-call (method "to_str") (constraint-fn-var 301)
											(receiver
												(e-lookup-local
													(p-assign (ident "first"))))
											(args)))
									(e-interpolation (constraint-fn-var 325) (dispatcher-var 26)
										(first
										...
										(parts
											...
											(e-literal (string ""))))))
							(guard
								(e-dispatch-call (method "is_gt") (constraint-fn-var 278)
									(receiver
										...
										(e-dispatch-call (method "to_str") (constraint-fn-var 337)
											(receiver
												(e-lookup-local
													(p-assign (ident "x"))))
											(args)))
									(e-interpolation (constraint-fn-var 361) (dispatcher-var 43)
										(first
