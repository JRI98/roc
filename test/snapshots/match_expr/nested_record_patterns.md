				...
				(value
					(e-block
						...
						(s-let
							...
							(e-lookup-local
								(p-assign (ident "country"))))
						(e-interpolation (constraint-fn-var 305) (dispatcher-var 27)
							(first
								(e-literal (string "")))
							(parts
								(e-lookup-local
				...
				(value
					(e-block
						...
						(s-let
							...
							(e-dispatch-call (method "to_str") (constraint-fn-var 310)
								(receiver
									(e-lookup-local
										(p-assign (ident "age"))))
								(args)))
						(s-let
							...
							(e-lookup-local
								(p-assign (ident "city"))))
						(e-interpolation (constraint-fn-var 330) (dispatcher-var 59)
							(first
								(e-literal (string "")))
							(parts
								(e-lookup-local
				...
				(value
					(e-block
						(s-let
							...
							(e-lookup-local
								(p-assign (ident "value"))))
						(e-interpolation (constraint-fn-var 351) (dispatcher-var 76)
							(first
				...
				(value
					(e-block
						(s-let
							...
							(e-lookup-local
								(p-assign (ident "simple"))))
						(e-interpolation (constraint-fn-var 370) (dispatcher-var 89)
							(first
