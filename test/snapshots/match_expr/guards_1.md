										...
										(e-dispatch-call (method "to_str") (constraint-fn-var 282)
											(receiver
												(e-lookup-local
													(p-assign (ident "x"))))
											(args)))
									(e-interpolation (constraint-fn-var 306) (dispatcher-var 20)
										(first
										...
										(parts
											...
											(e-literal (string ""))))))
							(guard
								(e-dispatch-call (method "is_gt") (constraint-fn-var 259)
									(receiver
										(e-lookup-local
											(p-assign (ident "x"))))
									(args
							...
							(value
								(e-block
									(s-let
										...
										(e-dispatch-call (method "to_str") (constraint-fn-var 339)
											(receiver
												(e-lookup-local
													(p-assign (ident "x"))))
											(args)))
									(e-interpolation (constraint-fn-var 363) (dispatcher-var 35)
										(first
										...
										(parts
											...
											(e-literal (string ""))))))
							(guard
								(e-dispatch-call (method "is_lt") (constraint-fn-var 316)
									(receiver
										(e-lookup-local
											(p-assign (ident "x"))))
									(args
