								...
								(e-block
									...
									(e-interpolation (constraint-fn-var 298) (dispatcher-var 20)
										...
										(parts
											...
											(e-literal (string ""))))))
							(guard
								(e-dispatch-call (method "is_gt") (constraint-fn-var 251)
									(receiver
										(e-lookup-local
											(p-assign (ident "x"))))
									(args
										...
										(e-dispatch-call (method "to_str") (constraint-fn-var 331)
											(receiver
												(e-lookup-local
													(p-assign (ident "x"))))
											(args)))
									(e-interpolation (constraint-fn-var 355) (dispatcher-var 35)
										(first
										...
										(parts
											...
											(e-literal (string ""))))))
							(guard
								(e-dispatch-call (method "is_lt") (constraint-fn-var 308)
									(receiver
										(e-lookup-local
											(p-assign (ident "x"))))
									(args
