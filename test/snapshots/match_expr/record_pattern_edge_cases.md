				...
				(value
					(e-block
						(s-let
							...
							(e-lookup-local
								(p-assign (ident "c"))))
						(e-interpolation (constraint-fn-var 327) (dispatcher-var 15)
							(first
				...
				(value
					(e-block
						(s-let
							...
							(e-lookup-local
								(p-assign (ident "x"))))
						(e-interpolation (constraint-fn-var 347) (dispatcher-var 30)
							(first
				...
				(value
					(e-block
						...
						(s-let
							...
							(e-lookup-local
								(p-assign (ident "simple"))))
						(e-interpolation (constraint-fn-var 368) (dispatcher-var 52)
							(first
				...
				(value
					(e-block
						...
						(s-let
							...
							(e-lookup-local
								(p-assign (ident "d"))))
						(e-interpolation (constraint-fn-var 390) (dispatcher-var 76)
							(first
							...
							(e-dispatch-call (method "to_str") (constraint-fn-var 413)
								(receiver
									(e-lookup-local
										(p-assign (ident "userAge"))))
								(args)))
						(e-interpolation (constraint-fn-var 432) (dispatcher-var 112)
							(first
