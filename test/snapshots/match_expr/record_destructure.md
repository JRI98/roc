				...
				(value
					(e-block
						...
						(s-let
							...
							(e-dispatch-call (method "to_str") (constraint-fn-var 246)
								(receiver
									(e-lookup-local
										(p-assign (ident "age"))))
								(args)))
						(e-interpolation (constraint-fn-var 265) (dispatcher-var 19)
							(first
								(e-literal (string "")))
							(parts
								(e-lookup-local
				...
				(value
					(e-block
						...
						(s-let
							...
							(e-lookup-local
								(p-assign (ident "name"))))
						(e-interpolation (constraint-fn-var 286) (dispatcher-var 41)
							(first
								(e-literal (string "")))
							(parts
								(e-lookup-local
