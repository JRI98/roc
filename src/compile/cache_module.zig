...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0x9C, 0x92, 0x03, 0xE2, 0xA5, 0xAF, 0xE1, 0x84, 0x9E, 0xFE, 0x4B, 0xC7, 0x26, 0x23, 0x3C, 0xE3,
        0xAF, 0xA2, 0x5F, 0xB2, 0xA6, 0xA7, 0x9A, 0x83, 0xF3, 0x5D, 0xEF, 0x95, 0x90, 0xC0, 0xCF, 0x12,
    };
