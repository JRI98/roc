...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0xD6, 0xCA, 0x61, 0x1C, 0x2D, 0x1F, 0x2F, 0xB4, 0x1D, 0xFF, 0x6F, 0xD8, 0x13, 0xDE, 0xAE, 0xAD,
        0x28, 0xC3, 0xEA, 0xC5, 0x76, 0xC2, 0xD1, 0x4F, 0xFF, 0x76, 0xC6, 0x92, 0x0D, 0x56, 0x7B, 0x42,
    };
