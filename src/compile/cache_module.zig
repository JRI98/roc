...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0x57, 0x56, 0x65, 0x28, 0xB7, 0xA3, 0xB8, 0x78, 0x9C, 0xC7, 0xF9, 0xC0, 0xF3, 0xB6, 0xCF, 0xB1,
        0x50, 0xB5, 0x5C, 0x2B, 0x23, 0x3F, 0xAC, 0x96, 0x3E, 0xD2, 0x11, 0x82, 0xBC, 0x1F, 0x48, 0xCC,
    };
