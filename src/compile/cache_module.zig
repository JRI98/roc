...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0x85, 0xEA, 0x1F, 0xE8, 0xBA, 0x65, 0x42, 0x49, 0x02, 0x36, 0x7F, 0xD2, 0x77, 0xAD, 0x1F, 0xEB,
        0x69, 0x3C, 0x70, 0xC7, 0x64, 0xB3, 0x8C, 0xC6, 0x9C, 0xFB, 0x9F, 0x9A, 0x96, 0xD6, 0x60, 0x65,
    };
