...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0x32, 0xE7, 0xA0, 0x68, 0xD8, 0xDE, 0x25, 0x17, 0x8D, 0x95, 0x9E, 0xAC, 0xCE, 0x0F, 0x9E, 0xDB,
        0x80, 0xC9, 0xF1, 0xA3, 0xD6, 0xAC, 0x2D, 0x13, 0x08, 0xB7, 0x08, 0xE2, 0x11, 0xF6, 0x4E, 0x0A,
    };
