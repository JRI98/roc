...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0xEE, 0x99, 0xCA, 0x7A, 0xF0, 0xBB, 0xB7, 0x1B, 0xDA, 0x94, 0x2E, 0xFC, 0x43, 0xB6, 0xDA, 0x8A,
        0xD1, 0x7A, 0xE4, 0x66, 0x06, 0x1F, 0x78, 0xE3, 0x5F, 0x74, 0x1D, 0x78, 0x77, 0x79, 0x93, 0xC5,
    };
