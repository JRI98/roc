...
| Compiler-emitted layout facts: field order, offsets, discriminants, size, alignment, zero-sized values, and Bool representation | Glue consumers must use reflected layout metadata and generated assertions rather than reconstructing layout | TBA |
